...
export const CharacterController = ({
   ...
   const { playAudio } = useAudioManager();
    ...
    if (inTheAir.current && vel.y > 2) {
      ...
      setAnimation("unnamed.001|spongebob_idle01.anm");
      state.setState("animation", "unnamed.001|spongebob_idle01.anm");
    } else if (movement > 1 || inTheAir.current) {
      setAnimation("unnamed.001|spongebob_run02.anm");
      state.setState("animation", "unnamed.001|spongebob_run02.anm");
    } else {
      setAnimation("unnamed.001|spongebob_idle01.anm");
      state.setState("animation", "unnamed.001|spongebob_idle01.anm");
    }
