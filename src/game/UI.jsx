    ...
    >
      {timer>=0 &&( 
       ...
       {timer}
        ...
        <a href="https://dexscreener.com/solana/48jg8os6fhddahz7j2ajru2tjrvdjn3mwuzjraskfcuy">
        ...
        <a href="https://x.com/spongle4bob">
      ...
      <img src="/images/bob/slogo.png" className="absolute top-4 left-2 w-14 h-14 md:w-28 md:h-28 sm:w-14 sm:h-14" />
      {stage === "lobby" && (
        <>
          {host ? (
            <button
